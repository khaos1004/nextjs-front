...
const erp: items[] = [
    { id: 1, label: 'ERP 관리', url: '/groupware/management' },
    { id: 2, label: 'ERP 정보', url: '/groupware/management' },
    { id: 3, label: '서비스 소개', url: '/groupware/management' },
    { id: 4, label: '서비스 요금', url: '/groupware/management' },
    { id: 5, label: '자료실', url: '/groupware/management' },
    { id: 6, label: '무료체험', url: '/groupware/management' },
    { id: 7, label: '고객센터', url: '/groupware/management' },
];
